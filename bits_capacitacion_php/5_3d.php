<?php
    ...
    foreach($employees as $empleados) {
        ...
        if ($empleados["Salary"] > 2000000) {
            echo $empleados["Firstname"] . " tiene salario alto <br>";
            echo $empleados["Salary"] . "<br>";
        }
        if ($empleados["Salary"] > 1000000 && $empleados["Salary"] < 2000000) {
    ...
    if ($employees[42]["Salary"] > 1000000 || $employees[42]["Salary"] < 2000000) {
        echo $employees[42]["Firstname"] . " " . $employees[3]["Lastname"] . " con ID: " . "42" . ", tiene un salario medio <br><br>";
    }
    ...
    foreach($employees as $empleados) {
        if ($empleados["Salary"] > 2000000) {
            echo $empleados["Firstname"] . " tiene salario mas alto de todos<br>";
            echo $empleados["Salary"] . "<br>";
        }
    }
