<?php
    ...
    if ($employees[13]["Salary"] < 1000000) {
        echo $employees[13]["Firstname"] . " " . $employees[13]["Lastname"] 
        . " con ID: " . key($employees) . ", tiene un salario bajo <br>";

        if ($employees[3]["Salary"] > 2000000) {
            echo $employees[3]["Firstname"] . " " . $employees[3]["Lastname"] 
            . " con ID: " . "3" . ", tiene un salario alto <br>";

            if ($employees[42]["Salary"] > 1000000 
                || $employees[42]["Salary"] < 2000000
            ) {
                echo $employees[42]["Firstname"] . " " . $employees[42]["Lastname"] 
                . " con ID: " . "42" . ", tiene un salario medio <br><br>";
            }
        }
    }
